...
namespace SabreTools.Compression.Deflate
{
    ...
    ///   <c>SabreTools.Compression.Deflate.GZipStream</c> can compress while writing, or decompress while
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        ///     {
        ///         using (Stream decompressor= new SabreTools.Compression.Deflate.GZipStream(input, CompressionMode.Decompress, true))
        ///         {
        ...
        ///         Using decompressor As Stream = new SabreTools.Compression.Deflate.GZipStream(input, CompressionMode.Decompress, True)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == SabreTools.Compression.Deflate.ZlibBaseStream.StreamMode.Undefined)
            {
